...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe 'POST #create' do
    it 'increases the number of questions by 1' do
      expect{ post :create, question: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: true}}.to change(Question, :count)
    end
